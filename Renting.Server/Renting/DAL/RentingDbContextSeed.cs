...
namespace Renting.DAL
{
    public class RentingDbContextSeed
    {
        public static async Task InitializeDb(RentingDbContext db)
        {
            ...
            var penalty1 = new Penalty() { Name = "Поломка", Value = 10000, Rent = rent1, PenaltyType = penaltyType1 };
            var penalty2 = new Penalty() { Name = "Поломка", Value = 100, Rent = rent2, PenaltyType = penaltyType2 };
            var penalty3 = new Penalty() { Name = "Поломка", Value = 10, Rent = rent3, PenaltyType = penaltyType3 };
